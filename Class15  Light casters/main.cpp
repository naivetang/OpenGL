...
int main()
{
	...
	// TODO::注意Png图片最后一个参数选中STBI_rgb，jpg图片填0就行

	data = stbi_load("container2.png", &width, &height, &nrChannels, STBI_rgb);
	...
	data = stbi_load("container2_specular.png", &width, &height, &nrChannels, STBI_rgb);
	...
	vec3 lightPos = vec3(0.2f, 2.0f, 0.0f);
