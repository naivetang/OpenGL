...
int main()
{
	...
	Shader ourShader("ModelVShader.glsl", "ModelFShader.glsl", "ModelGShader.glsl");

	Shader modelNormShader("ModelVNormShader.glsl", "ModelFNormShader.glsl", "ModelGNormShader.glsl");
	...
	Shader pointShader("PointVShader.glsl","PointFShader.glsl","PointGShader.glsl");
...
glm::vec3(-1.3f,  1.0f, -1.5f)
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 渲染模型
		Render(window, ourShader, model, projection, view, dirLightDir, pointLightPositions, spotLightPos, spotLightDir, ourModel);

		modelNormShader.user();

		Render(window, modelNormShader, model, projection, view, dirLightDir, pointLightPositions, spotLightPos, spotLightDir, ourModel);
